// create-perfect-schema.js
// Create perfect schema according to PLAN specifications
...
async function createPerfectSchema() {
  try {
    console.log('🔧 Creating perfect schema according to PLAN...');
    ...
    const quizzesSchema = {
      ...
      schema: [
        ...
        },
        {
          ...
          "type": "relation",
          "options": {
            "collectionId": questionsResult.id,
            "cascadeDelete": false,
            "maxSelect": 0,
            "minSelect": 0
          }
    ...
    const submissionsResult = await pb.collections.create(submissionsSchema);
    console.log('✅ Submissions collection created successfully!');
    console.log(`📋 Submissions ID: ${submissionsResult.id}`);
    
    console.log('\n🎉 Perfect schema created successfully!');
    console.log('\n📋 Collection IDs:');
    console.log(`   Questions: ${questionsResult.id}`);
    console.log(`   Quizzes: ${quizzesResult.id}`);
    console.log(`   Submissions: ${submissionsResult.id}`);
